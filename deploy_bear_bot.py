""" This is the bot script for deploying bear bot to Discord. 
...
def is_mentioned(me: discord.ClientUser, message: discord.Message, chance_without_mention: float = 0.10) -> bool:

""" This is the bot script for deploying Mr. Bitbot to Discord. 
Note that this just activates him, you still have to manually add him to servers
...
AGENT_NAME = os.getenv("AGENT_NAME", "bitbot")        
...
# Helper function to assist with filtering messages from bots
...
def is_mentioned(me: discord.ClientUser, message: discord.Message, chance_without_mention: float = 0.13) -> bool:
...
BOT_NAME = AGENT_NAME
PERSONA = """You are a cyborb version of Jordan Belfort, Leonardo DiCaprio's character from wolf of wall street.
...
async def autotrade_loop():
    ...
    while not client.is_closed():
        try:
            ...
            if brag_cope and random.random() < 0.25:
